...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            "dataset",
            True,
            id="Should valid for dataset_name which contains of letters",
        ),
        pytest.param(
            "_dataset",
            True,
            id="Should valid for dataset_name which begin with underscore and followed by letters",
        ),
        pytest.param(
            "1dataset",
            True,
            id="Should valid for dataset_name which begin with number and followed by letters",
        ),
        pytest.param(
        ...
        pytest.param(
            "dataset?ok",
            False,
            id="Should not valid for dataset_name which contains of question mark",
        ),
        pytest.param(
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "_column",
            True,
            id="Should valid if column_name begins with underscore and followed with letters",
        ),
        pytest.param(
            "Column",
            True,
            id="Should valid if column_name contains all letters regardless uppercase or lowercase",
        ),
        pytest.param(
        ...
        pytest.param(
            "column?1",
            False,
            id="Should not valid if column_name contains ? or any special characters",
        ),
        pytest.param(
            "column?",
            False,
            id="Should not valid if column_name contains ? or any special characters(2)",
        ),
        pytest.param(
        ...
        pytest.param(
            "_PARTITION2",
            False,
            id="Should not valid if column_name has prefix _PARTITION",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "_table",
            True,
            id="Should valid if table_name is begin with underscore and followed by letters",
        ),
        pytest.param(
            "1table",
            True,
            id="Should valid if table_name is begin with number and followed by letters",
        ),
        pytest.param(
            "+table",
            False,
            id="Should not valid if table_name contains of + or any special characters",
        ),
        pytest.param(
            "table?ok",
            False,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "project-with-dash-and-number-007.dataset.table",
            True,
        ...
        pytest.param(
            "project. dataset.table",
            False,
            id="Should not valid if source_table contains invalid dataset",
        ),
        pytest.param(
            "project.dataset .table",
            False,
            id="Should not valid if source_table contains invalid dataset(2)",
        ),
        pytest.param(
            "project.dataset?.table",
            False,
            id="Should not valid if source_table contains invalid dataset(3)",
        ),
        pytest.param(
            "project.dataset. table",
            False,
            id="Should not valid if source_table contains invalid table",
        ),
        pytest.param(
            "project.dataset.table ",
            False,
            id="Should not valid if source_table contains invalid table(2)",
        ),
        pytest.param(
            "project.dataset.table?table",
            False,
            id="Should not valid if source_table contains invalid table(3)",
        ),
        pytest.param(
            ".dataset.table",
            False,
            id="Should not valid if source_table doesnt have project_id info",
        ),
        pytest.param(
            "    abc.dataset.table",
            False,
            id="Should not valid if source_table contains invalid project_id",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ["column1", "column2"],
            True,
            id="Should valid if all columns contains of letters",
        ),
        pytest.param(
            ["coLumn1", "column2"],
            True,
            id="Should valid if all columns contains of letters(2)",
        ),
        pytest.param(
            ["?column1", "column2"],
            False,
            id="Should valid if one of the columns contains invalid column",
        ),
        pytest.param(
            ["column1", "12column2"],
            False,
