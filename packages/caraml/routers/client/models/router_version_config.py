...
class RouterVersionConfig(BaseModel):
    """
    RouterVersionConfig
    """ # noqa: E501
    routes: List[Route]
    ...
    __properties: ClassVar[List[str]] = ["routes", "rules", "default_route_id", "default_traffic_rule", "experiment_engine", "resource_request", "autoscaling_policy", "timeout", "protocol", "log_config", "enricher", "ensembler"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of RouterVersionConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of RouterVersionConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "log_config": RouterVersionConfigLogConfig.from_dict(obj.get("log_config")) if obj.get("log_config") is not None else None,
