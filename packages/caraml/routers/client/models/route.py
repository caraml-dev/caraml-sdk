...
class Route(BaseModel):
    ...
    service_method: Optional[StrictStr] = None
    annotations: Optional[Union[str, Any]] = None
    __properties: ClassVar[List[str]] = ["id", "type", "endpoint", "timeout", "service_method", "annotations"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "service_method": obj.get("service_method"),
