...
class EnsemblerDockerConfig(BaseModel):
    """
    ensembler config when ensembler type is docker
    """ # noqa: E501
    image: Annotated[str, Field(strict=True)]
    ...
    __properties: ClassVar[List[str]] = ["image", "resource_request", "autoscaling_policy", "endpoint", "timeout", "port", "env", "service_account"]

    @field_validator('image')
    def image_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^([a-zA-Z0-9]+(?:[._-][a-zA-Z0-9]+)*(?::\d{2,5})?\/)?([a-zA-Z0-9]+(?:[._-][a-zA-Z0-9]+)*\/)*([a-zA-Z0-9]+(?:[._-][a-zA-Z0-9]+)*)(?::[a-zA-Z0-9]+(?:[._-][a-zA-Z0-9]+)*)?$", value):
            raise ValueError(r"must validate the regular expression /^([a-zA-Z0-9]+(?:[._-][a-zA-Z0-9]+)*(?::\d{2,5})?\/)?([a-zA-Z0-9]+(?:[._-][a-zA-Z0-9]+)*\/)*([a-zA-Z0-9]+(?:[._-][a-zA-Z0-9]+)*)(?::[a-zA-Z0-9]+(?:[._-][a-zA-Z0-9]+)*)?$/")
        return value
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of EnsemblerDockerConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of EnsemblerDockerConfig from a dict"""
        if obj is None:
            return None
