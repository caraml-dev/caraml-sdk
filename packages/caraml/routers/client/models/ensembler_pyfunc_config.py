...
class EnsemblerPyfuncConfig(BaseModel):
    """
    ensembler config when ensembler type is pyfunc
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["project_id", "ensembler_id", "resource_request", "autoscaling_policy", "timeout", "env"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of EnsemblerPyfuncConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of EnsemblerPyfuncConfig from a dict"""
        if obj is None:
            return None
