...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = EnsemblerApi()
        api_instance.create_ensembler  # this is an instance of the class Endpoint
        api_instance.create_ensembler()  # this invokes api_instance.create_ensembler.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_ensembler.callable or self.callable in this class
