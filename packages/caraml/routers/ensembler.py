...
from routers.client.models import EnsemblerType
from routers._base_types import ApiObject, ApiObjectSpec
from routers.batch import EnsemblingJob, EnsemblingJobStatus
from routers.batch.config import EnsemblingJobConfig
...
@ApiObjectSpec(routers.client.models.Ensembler)
...
@ApiObjectSpec(routers.client.models.PyFuncEnsembler)
