...
def setup(app):
    ...
    app.add_node(
        AdmonitionNode,
        confluence=(visit_AdmonitionNode, depart_AdmonitionNode),
        override=True,
    )
    app.add_node(
        CodeAreaNode,
        confluence=(visit_CodeAreaNode, depart_CodeAreaNode),
        override=True,
    )
    app.add_node(
        FancyOutputNode, confluence=(visit_FancyOutputNode, None), override=True
    )
