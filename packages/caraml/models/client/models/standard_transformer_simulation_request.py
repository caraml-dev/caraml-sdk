...
class StandardTransformerSimulationRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["payload", "headers", "config", "model_prediction_config", "protocol"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "model_prediction_config": ModelPredictionConfig.from_dict(obj.get("model_prediction_config")) if obj.get("model_prediction_config") is not None else None,
