...
class ModelEndpointsApi:
    ...
    def models_model_id_endpoints_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ModelEndpoint]]:
        """List model endpoint
    ...
    def models_model_id_endpoints_model_endpoint_id_put(
        ...
        model_id: StrictInt,
        model_endpoint_id: StrictInt,
        body: Optional[ModelEndpoint] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def models_model_id_endpoints_post(
        ...
        :param model_id: (required)
        :type model_id: int
        :param body: Model endpoint object that has to be added (required)
        :type body: ModelEndpoint
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def projects_project_id_model_endpoints_get(
        ...
        :param project_id: Filter list of model endpoints by specific `project_id` (required)
        :type project_id: int
        :param region: Filter list of model endpoints by specific environment's `region`
        :type region: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
