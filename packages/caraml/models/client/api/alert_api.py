...
class AlertApi(object):
    ...
    def alerts_teams_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        body_params = None
        # HTTP header `Accept`
        header_params['Accept'] = self.api_models.client.select_header_accept(
            ['*/*'])  # noqa: E501

        # Authentication setting
        auth_settings = ['Bearer']  # noqa: E501

        return self.api_models.client.call_api(
            '/alerts/teams', 'GET',
            path_params,
            query_params,
            header_params,
    ...
    def models_model_id_endpoints_model_endpoint_id_alert_post_with_http_info(self, model_id, model_endpoint_id, **kwargs):  # noqa: E501
        ...
        header_params['Content-Type'] = self.api_models.client.select_header_content_type(  # noqa: E501
            ['*/*'])  # noqa: E501
