...
class ModelsApi:
    ...
    def projects_project_id_models_get(
        ...
        :param project_id: Filter list of models by specific `project_id` (required)
        :type project_id: int
        :param name: Filter list of models by specific models `name`
        :type name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def projects_project_id_models_model_id_delete(
        ...
        :param project_id: project id of the project to be deleted (required)
        :type project_id: int
        :param model_id: model id of the model to be deleted (required)
        :type model_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def projects_project_id_models_model_id_get(
        ...
        :type project_id: int
        :param model_id: model id of the model to be retrieved (required)
        :type model_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def projects_project_id_models_post(
        ...
        :param project_id: Create new model in a specific `project_id` (required)
        :type project_id: int
        :param body:
        :type body: Model
        :param _request_timeout: timeout setting for this request. If one
