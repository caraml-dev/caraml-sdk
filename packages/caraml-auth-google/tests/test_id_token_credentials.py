...
# This test package is drawn from Airflow's test package to test Google utils to connect to Google related client libraries.
# Refer to the following link for the original file:
# https://github.com/apache/airflow/blob/47ab0ca6295f301d393dbb29e134fa90be0ad7df/tests/providers/google/common/utils/test_id_token_credentials.py
...
class TestGetDefaultIdTokenCredentials:
    ...
    @mock.patch.dict("os.environ")
    @mock.patch(
        "caraml_auth.id_token_credentials.open",
        mock.mock_open(
