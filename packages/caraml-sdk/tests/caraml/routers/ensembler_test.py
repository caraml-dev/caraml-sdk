...
def test_predict():
    ...
    ensembler = utils.MyTestEnsembler(default_value)
...
def test_list_ensemblers(
    ...
    responses.add(
        ...
        body=json.dumps(page, default=utils.json_serializer),
...
def test_create_ensembler(
    ...
    responses.add(
        ...
        body=json.dumps(pyfunc_ensembler, default=utils.json_serializer),
        status=201,
        content_type="application/json",
    )
    ...
    actual = turing.PyFuncEnsembler.create(
        ...
        ensembler_instance=utils.MyTestEnsembler(0.01),
        conda_env={
            "channels": ["defaults"],
...
def test_update_ensembler(
    ...
    responses.add(
        ...
        body=json.dumps([], default=utils.json_serializer),
        status=200,
        content_type="application/json",
    )
    ...
    responses.add(
        ...
        body=json.dumps(emptyJob, default=utils.json_serializer),
        status=200,
        content_type="application/json",
    )
    ...
    actual.update(
        name=pyfunc_ensembler.name,
        ensembler_instance=utils.MyTestEnsembler(0.06),
        conda_env={
            "channels": ["defaults"],
