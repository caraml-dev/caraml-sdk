...
from caraml.routers.ensembler import EnsemblerType
from caraml.routers.client import ApiClient, Configuration
from caraml.routers.client.apis import (
    EnsemblerApi,
    EnsemblingJobApi,
    ProjectApi,
    RouterApi,
...
from caraml.routers.version import VERSION

from caraml.mlp.client.models import Project
from caraml.mlp.mlp_client import MLPClient, require_active_project
...
class TuringSession:
    ...
    def get_router_version(self, router_id: int, version: int) -> RouterVersion:
        ...
        """
        return (
            self._router_api.projects_project_id_routers_router_id_versions_version_get(
