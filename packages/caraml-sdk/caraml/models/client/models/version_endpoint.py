        ...
        _obj = cls.model_validate(
            {
                ...
                "transformer": Transformer.from_dict(obj.get("transformer"))
                if obj.get("transformer") is not None
                else None,
                "logger": Logger.from_dict(obj.get("logger"))
                if obj.get("logger") is not None
                else None,
                "deployment_mode": obj.get("deployment_mode"),
                "autoscaling_policy": AutoscalingPolicy.from_dict(
                    obj.get("autoscaling_policy")
                )
                if obj.get("autoscaling_policy") is not None
                else None,
